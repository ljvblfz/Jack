...
/**
 * A {@code PatternElement} represents the name of a package or a set of packages if used with the
 * {@link Wildcard} based syntax.
 */
public abstract class PatternElement {
  ...
  public static List<Wildcard> createWildcards(List<? extends PatternElement> patterns) {
