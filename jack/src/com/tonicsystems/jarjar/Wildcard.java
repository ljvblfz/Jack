...
/**
 * This class holds the logic behind the jarjar {@code Wildcard} syntax. It is used to check whether
 * a package name matches the associated pattern or to transform this package name according to a
 * {@Rule}.
 */
