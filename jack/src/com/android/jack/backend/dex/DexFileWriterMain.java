...
/**
 * Merge dexes marked with MainDexMarker.
 */
@Description("Merge dexes marked with MainDexMarker")
@Name("DexFileWriterMain")
@Produce(MainMultiDexProduct.class)
public class DexFileWriterMain extends DexFileWriter {
