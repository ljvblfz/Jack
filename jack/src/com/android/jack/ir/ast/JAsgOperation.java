 ...
 */
@Description("Assign operator expression")
public class JAsgOperation extends JAsgBinaryOperation {

  /**
   * Assign which value is not reused.
   */
  @Description("Assign which value is not reused")
