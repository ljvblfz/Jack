...
/**
 * Unary operator expression for {@code prefix not}.
 */
...
public class JPrefixNotOperation extends JPrefixOperation {
  ...
  @Override
  @Nonnull
  // Section Logical Complement Operator ! (JLS-7 15.15.6)
  public JType getType() {
    assert JPrimitiveTypeEnum.BOOLEAN.getType().isEquivalent(getArg().getType());
