...
public class ToStringGenerationVisitor extends TextOutputVisitor {
  ...
  private static final char[] CHARS_ABSTRACT = "abstract ".toCharArray();
  private static final char[] CHARS_ALLOC = "alloc ".toCharArray();
  private static final char[] CHARS_ASSERT = "assert ".toCharArray();
  ...
  private static final char[] CHARS_COMMA = ", ".toCharArray();
  ...
  private static final char[] CHARS_DOTCLASS = ".class".toCharArray();
  private static final char[] CHARS_ELSE = "else".toCharArray();
  private static final char[] CHARS_MULTI_CATCH = "|".toCharArray();
  private static final char[] CHARS_EXTENDS = "extends ".toCharArray();
  private static final char[] CHARS_FALSE = "false".toCharArray();
  private static final char[] CHARS_FINAL = "final ".toCharArray();
  private static final char[] CHARS_FINALLY = " finally ".toCharArray();
  private static final char[] CHARS_FOR = "for ".toCharArray();
  private static final char[] CHARS_GOTO = "goto".toCharArray();
  private static final char[] CHARS_IF = "if ".toCharArray();
  private static final char[] CHARS_IMPLEMENTS = "implements ".toCharArray();
  private static final char[] CHARS_INSTANCEOF = " instanceof ".toCharArray();
  ...
  private static final char[] CHARS_REINTERPRETCAST = "reinterpret-cast ".toCharArray();
  private static final char[] CHARS_RETURN = "return".toCharArray();
  private static final char[] CHARS_RUNTIME_EXCEPTION = "Runtime exception of type".toCharArray();
  ...
  private static final char[] SYNCHRONIZED_BLOCK = "synchronized ".toCharArray();
  private static final char[] LOCK = "lock ".toCharArray();
  private static final char[] UNLOCK = "unlock ".toCharArray();
