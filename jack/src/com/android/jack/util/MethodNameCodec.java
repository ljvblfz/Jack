 ...
 */
public class MethodNameCodec implements StringCodec<String>{

  @Override
  @Nonnull
  public String getUsage() {
    return "a java method name (e.g. java.lang.Object#toString)";
  }
  ...
  public String checkString(@Nonnull CodecContext context, @Nonnull String string)
    ...
    if (!NamingTools.isFullMethodName(string)) {
  ...
  public void checkValue(@Nonnull CodecContext context, @Nonnull String data)
    ...
    if (!NamingTools.isFullMethodName(data)) {
