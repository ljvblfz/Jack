...
/**
 * Binary operator expression for {@code prefix inc}.
 */
public class NPrefixIncOperation extends NExpression {

  @Nonnull
  public static final Token TOKEN = Token.PREFIX_INC_OPERATION;
