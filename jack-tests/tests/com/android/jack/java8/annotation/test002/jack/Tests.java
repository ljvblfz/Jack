...
public class Tests {
  ...
  public void testGetAnnotationFromClass() {
    Author[] authors = new Annotation002().getAuthorsAnnotationFromClass();
  ...
  public void testGetAnnotationFromField() {
    try {
      Author[] authors = new Annotation002().getAuthorsAnnotationFromField();
  ...
  public void testGetAnnotationFromMethod() {
    try {
      Author[] authors = new Annotation002().getAuthorsAnnotationFromMethod();
  ...
  public void testGetAnnotationFromMethodParameter() {
    try {
      Author[] authors = new Annotation002().getAuthorsAnnotationFromMethodParameter();
