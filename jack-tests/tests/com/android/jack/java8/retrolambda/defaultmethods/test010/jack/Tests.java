...
package com.android.jack.java8.retrolambda.defaultmethods.test010.jack;
...
private interface RefineArgChild extends RefineArgParent<String> {
  ...
  public void default_method_argument_type_refined_in_child_interface() {
      ...
      Assert.assertEquals("direct call", child.foo("42"), "refined 42");
      Assert.assertEquals("bridged call", ((RefineArgParent<String>) child).foo("42"), (Object) "refined 42");
  }
