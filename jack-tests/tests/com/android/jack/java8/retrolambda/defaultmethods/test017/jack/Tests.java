...
package com.android.jack.java8.retrolambda.defaultmethods.test017.jack;
...
private interface SuperCallChild extends SuperCallParent {
  ...
  public void default_methods_called_with_super() {
      ...
      Assert.assertEquals(new C().callSuper(), 111);
      Assert.assertEquals(new C().siblingCallingSuper(), 1011);
  }
