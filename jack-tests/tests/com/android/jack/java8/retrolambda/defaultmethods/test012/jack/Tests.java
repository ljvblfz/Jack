...
package com.android.jack.java8.retrolambda.defaultmethods.test012.jack;
...
private interface OverrideRefineChild extends OverrideRefineParent {
  ...
  public void default_method_type_refined_and_overridden_in_child_interface() {
      ...
      Assert.assertEquals("direct call", child.foo(), "overridden and refined");
      Assert.assertEquals("bridged call", ((OverrideRefineParent) child).foo(), (Object) "overridden and refined");
  }
