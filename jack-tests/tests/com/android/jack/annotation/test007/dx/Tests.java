...
package com.android.jack.annotation.test007.dx;

import com.android.jack.annotation.test007.jack.Thrower;
...
public class Tests {
  ...
  public void testGenericExceptionsOfConstructorsWithTypeParameters() throws Exception {
    ...
    Assert.assertEquals(Arrays.<Type>asList(IOException.class),
