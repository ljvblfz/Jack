...
public class EcjMethodHandleTest extends MethodHandleTest {

  public EcjMethodHandleTest(@Nonnull String name) {
    super(name);
  }
      ...
      try {
        filter(new Filter() {
          ...
          public boolean shouldRun(Description description) {
            if (testWithOtherErrorMsg.contains(description.getMethodName())) {
              return false;
            }
            return true;
          }
  ...
  @Nonnull
  private static final List<String> testWithOtherErrorMsg = Arrays.asList("test009", "test010");
  ...
  public static Test suite() {
   return new MyAdapter(EcjMethodHandleTest.class);
  }
