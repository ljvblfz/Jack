...
/**
 * The legacy android toolchain with desugar.
 */
public class LegacyDesugarToolchain extends LegacyBasedToolchain {

  LegacyDesugarToolchain(@Nonnull File legacyCompilerPrebuilt,
