...
/**
 * This {@link Toolchain} uses Jack through v03 API and performs two steps
 * compilation. Compilation from sources to to executables are thus
 * performed twice, by using an intermediate library.
 */
public class JackApiV03TwoStepsToolchain extends JackApiV03Toolchain implements TwoStepsToolchain {
  ...
  JackApiV03TwoStepsToolchain(@CheckForNull File jackPrebuilt) {
    super(jackPrebuilt);
  ...
  @Override
  @Nonnull
  public JackApiV03TwoStepsToolchain addProperty(
