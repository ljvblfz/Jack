...
/**
 * This {@link Toolchain} uses Jack through v03 API and perform incremental
 * compilation. Compilation are thus performed twice, while touching a source file
 * between the two calls.
 */
public class JackApiV03IncrementalToolchain
    extends JackApiV03Toolchain implements IncrementalToolchain {

  JackApiV03IncrementalToolchain(@CheckForNull File jackPrebuilt) {
    super(jackPrebuilt);
  }
