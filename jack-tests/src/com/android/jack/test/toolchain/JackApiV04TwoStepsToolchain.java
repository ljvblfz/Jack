...
/**
 * This {@link Toolchain} uses Jack through v04 API and performs two steps
 * compilation. Compilation from sources to to executables are thus
 * performed twice, by using an intermediate library.
 */
public class JackApiV04TwoStepsToolchain extends JackApiV04Toolchain implements TwoStepsToolchain {
  ...
  JackApiV04TwoStepsToolchain(@CheckForNull File jackPrebuilt) {
    super(jackPrebuilt);
  ...
  @Override
  @Nonnull
  public JackApiV04TwoStepsToolchain addProperty(
