...
public final class Form45cc extends InsnFormat {
  ...
  public boolean isCompatible(@Nonnull DalvInsn insn) {
    ...
    if (!unsignedFitsInShort(dualCstInsn.getFirstIndex())) {
      return false;
    }
    ...
    if (!unsignedFitsInShort(dualCstInsn.getSecondIndex())) {
      return false;
    }
  ...
  public void writeTo(@Nonnull AnnotatedOutput out, @Nonnull DalvInsn insn) {
    ...
    DualCstInsn dualCstInsn = (DualCstInsn) insn;
    write(out, opcodeUnit(insn, makeByte(r4, sz)), (short) dualCstInsn.getFirstIndex(),
        codeUnit(r0, r1, r2, r3), (short) dualCstInsn.getSecondIndex());
  }
