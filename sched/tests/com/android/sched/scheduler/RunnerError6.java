...
@Name("Runner Error 6")
@Description("Runner Error 6 description")
@OnlyFor(SchedTest.class)
@Optional(@ToSupport(feature = Feature1.class,
    add = @Constraint(need = {Tag1.class, Tag2.class, Tag3.class, Tag5.class})))
@Constraint(no = {Tag2.class, Tag4.class, Tag5.class})
@Transform(add = Tag1.class, remove = Tag2.class)
public class RunnerError6 implements RunnableSchedulable<Component0> {
  @Override
