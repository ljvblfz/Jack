...
@Name("Runner Error 7")
@Description("Runner Error 7 description")
@OnlyFor(SchedTest.class)
@Optional(@ToSupport(feature = Feature1.class,
    add = @Constraint(no = {Tag1.class, Tag2.class, Tag3.class, Tag5.class})))
@Constraint(need = {Tag2.class, Tag4.class, Tag5.class})
@Transform(add = Tag1.class, remove = Tag2.class)
public class RunnerError7 implements RunnableSchedulable<Component0> {
  @Override
