...
@Name("Runner Error 8")
@Description("Runner Error 8 description")
@OnlyFor(SchedTest.class)
@Optional(@ToSupport(feature = Feature1.class, add = @Constraint(
    no = {Tag1.class, Tag2.class, Tag3.class, Tag5.class},
    need = {Tag2.class, Tag4.class, Tag5.class})))
@Transform(add = Tag1.class, remove = Tag2.class)
public class RunnerError8 implements RunnableSchedulable<Component0> {
  @Override
