...
@Name("Visitor 4")
@Description("Visitor 4 description")
@OnlyFor(SchedTest.class)
public class Visitor4 implements AdapterSchedulable<Component0, Component3> {
  @Override
  @Nonnull
  public Iterator<Component3> adapt(@Nonnull Component0 b)
      throws Exception {
