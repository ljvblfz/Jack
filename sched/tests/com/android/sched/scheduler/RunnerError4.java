...
@Name("Runner Error 4")
@Description("Runner Error 4 description")
@OnlyFor(SchedTest.class)
@Transform(add = {Tag1.class, Tag2.class, Tag3.class, Tag5.class},
    remove = {Tag2.class, Tag4.class, Tag5.class})
public class RunnerError4 implements RunnableSchedulable<Component0> {
  @Override
