...
public interface ReflectionManager {
  /**
   * Returns a {@code Set} with all the sub-types found in the Classpath for a given class.
   */
  @Nonnull
  public <T> Set<Class<? extends T>> getSubTypesOf(@Nonnull Class<T> cls);

  /**
   * Returns a {@code Set} with all the sup-types found in the Classpath for a given class.
   */
  @Nonnull
